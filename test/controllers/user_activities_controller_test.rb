...
class UserActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_activity" do
    assert_difference("UserActivity.count") do
      post user_activities_url, params: { user_activity: { activity_type: @user_activity.activity_type, color: @user_activity.color, description: @user_activity.description, icon: @user_activity.icon, reference_id: @user_activity.reference_id, reference_type: @user_activity.reference_type, title: @user_activity.title, user_id: @user_activity.user_id } }
    end
  ...
  test "should update user_activity" do
    patch user_activity_url(@user_activity), params: { user_activity: { activity_type: @user_activity.activity_type, color: @user_activity.color, description: @user_activity.description, icon: @user_activity.icon, reference_id: @user_activity.reference_id, reference_type: @user_activity.reference_type, title: @user_activity.title, user_id: @user_activity.user_id } }
