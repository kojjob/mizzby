...
class ProductImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update product_image" do
    patch product_image_url(@product_image), params: { product_image: { alt_text: @product_image.alt_text, position: @product_image.position, product_id: @product_image.product_id } }
