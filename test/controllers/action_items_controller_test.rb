...
class ActionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action_item" do
    assert_difference("ActionItem.count") do
      post action_items_url, params: { action_item: { completed: @action_item.completed, description: @action_item.description, due_date: @action_item.due_date, priority: @action_item.priority, title: @action_item.title, user_id: @action_item.user_id } }
    end
  ...
  test "should update action_item" do
    patch action_item_url(@action_item), params: { action_item: { completed: @action_item.completed, description: @action_item.description, due_date: @action_item.due_date, priority: @action_item.priority, title: @action_item.title, user_id: @action_item.user_id } }
