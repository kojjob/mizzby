...
class CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create category" do
    assert_difference("Category.count") do
      post categories_url, params: { category: { description: @category.description, icon_color: @category.icon_color, icon_name: @category.icon_name, name: @category.name, parent_id: @category.parent_id, position: @category.position, slug: @category.slug, visible: @category.visible } }
    end
