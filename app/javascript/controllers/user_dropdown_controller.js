...
export default class extends Controller {
  ...
  show() {
    ...
    // Update ARIA
    this.element.querySelector('#user-menu-button').setAttribute('aria-expanded', 'true')
  }
  ...
  hide() {
    ...
    // Update ARIA
    this.element.querySelector('#user-menu-button').setAttribute('aria-expanded', 'false')
  }
